(function () {
    ...
    function mostrarFromulario(editar = false, tarea = {}) {
        //console.log(tarea);
        ...
        <div class="opciones">
            <input type="submit" id= "crear-tarea" class="submit-nueva-tarea" value="${editar ? 'Guardar Cambios' : 'Añadir Tarea'}">
